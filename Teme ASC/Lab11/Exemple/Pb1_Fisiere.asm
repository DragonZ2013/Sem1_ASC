...
segment code use32 class=code
    start:
        ...
        push dword text     
        call [fread]
        mov ebx,eax;salvarea lungimii (returnate in eax) in ebx
        ...
        std
        repeta:
            ;comparam continutul edi(textul) cu fiecare vocala pe rand
            mov al,"a"
            cmp al,byte[edi]
            JE inclabel
            mov al,"e"
            ...
            JMP skip
            inclabel:
            inc ebx ;cresterea contorului ebx
            skip:
            inc (edi)
        loop repeta
